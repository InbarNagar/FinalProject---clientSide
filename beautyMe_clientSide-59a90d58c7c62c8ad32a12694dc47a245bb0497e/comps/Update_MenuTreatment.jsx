 ...
 const { userDetails, setUserDetails } = useContext(UserContext);
  ...
  return (
    ...
    <View style={styles.container}>
      <Header text="הוספת טיפולים לתפריט" fontSize={50} height={200} color={"rgb(92, 71, 205)"} />
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        <TouchableOpacity onPress={showTimepicker}>
          <View style={styles.button}>
            <Text style={styles.buttonText}>בחר משך זמן הטיפול</Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity onPress={addTreatment} style={styles.button} >
        <View  disabled={!selectedTreatment || !selectedCategory || !price || !duration}>
          <Text style={styles.buttonText}>צור תפריט טיפולים</Text>
